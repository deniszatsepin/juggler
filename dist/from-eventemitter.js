...
function eventGenerator(emitter, eventName, copacity = Infinity) {
    return __asyncGenerator(this, arguments, function* eventGenerator_1() {
        ...
        while (true) {
            const val = yield __await(new Promise((resolve, reject) => {
                if (buffer.length) {
...
//# sourceMappingURL=from-eventemitter.js.map